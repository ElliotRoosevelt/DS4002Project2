#input df
##find file path for InitalPopulationDemographicData.csv and InitalCOIDataset.csv (data is accessible through How to Obtain Original Dataset file)
file.choose() 
##reading in files
orig=read.csv("C:\\Users\\ellea\\Desktop\\Life\\Undergrad UVA\\4th Year 2024-2025\\Spring 2025\\DS 4002 Project\\p2\\Data\\1_index\\OriginalCOIDataset.csv")
pop=read.csv("C:\\Users\\ellea\\Desktop\\Life\\Undergrad UVA\\4th Year 2024-2025\\Spring 2025\\DS 4002 Project\\p2\\Data\\3_pop\\OrigPopulationDemographicData.csv")
...
#creating new file called (make sure your directory is set to the right folder you want this file to be created in)
